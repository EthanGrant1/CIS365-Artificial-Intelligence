...
for i in range(1, 29):
	trainDatA.append(iris_dict[i][2])
		
for i in range(51, 79):
	trainDatB.append(iris_dict[i][2])

for i in range(100, 129):
	trainDatC.append(iris_dict[i][2])
...
def bayesian():
	...
	for i in range(30, 50):
		...
		probA = gau_density(iris_dict[i][2], devA, meanA)
		probB = gau_density(iris_dict[i][2], devB, meanB)
		probC = gau_density(iris_dict[i][2], devC, meanC)
